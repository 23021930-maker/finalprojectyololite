...
set C_modelArgList {
	...
	{ f2 float 32 regular {array 13456 { 1 3 } 1 1 } {global 0}  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.topp_fcmp_32ns_32dEe_U17", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "60065", "Max" : "60065"}
	, {"Name" : "Interval", "Min" : "60065", "Max" : "60065"}
]}
...
set Spec2ImplPortList { 
	...
	f2 { ap_memory {  { f2_address0 mem_address 1 14 }  { f2_ce0 mem_ce 1 1 }  { f2_q0 mem_dout 0 32 } } }
}
