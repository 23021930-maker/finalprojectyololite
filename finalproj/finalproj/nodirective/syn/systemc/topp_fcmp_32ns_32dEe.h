...
// ==============================================================
#ifndef __topp_fcmp_32ns_32dEe__HH__
#define __topp_fcmp_32ns_32dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(topp_fcmp_32ns_32dEe) {
    ...
    SC_CTOR(topp_fcmp_32ns_32dEe):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
