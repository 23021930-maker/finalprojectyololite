# ==============================================================
# File generated on Mon Jun 08 21:03:03 +0700 2026
...
if {[file isfile topp.autotvin.dat]} {
	file delete -force topp.autotvin.dat
}

if {[file isfile topp.autotvout.dat]} {
	file delete -force topp.autotvout.dat
}
