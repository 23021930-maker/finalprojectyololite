...
$(ObjDir)/tb_topp.c_pre.c.tb.o : tb_topp.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) tb_topp.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/topp.c_pre.c.tb.o : topp.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) topp.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
