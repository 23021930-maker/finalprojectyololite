...
// ==============================================================
#ifndef __topp_fexp_32ns_32dEe__HH__
#define __topp_fexp_32ns_32dEe__HH__
#include "ACMP_fexp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(topp_fexp_32ns_32dEe) {
    ...
    SC_CTOR(topp_fexp_32ns_32dEe):  ACMP_fexp_U ("ACMP_fexp_U") {
        ACMP_fexp_U.clk(clk);
