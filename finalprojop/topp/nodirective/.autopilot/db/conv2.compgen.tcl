...
set out_width 11
set exp (i0+i1)*i2
set arg_lists {i0 {5 0 +} i1 {2 1 +} s {6 1 +} i2 {6 0 +} p {11 1 +} c_expval {c} acc {0} }
set TrueReset 0
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename p1 \
    op interface \
    ports { p1_address0 { O 13 vector } p1_ce0 { O 1 bit } p1_q0 { I 32 vector } } \
} "
} else {
