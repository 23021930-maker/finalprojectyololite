...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename out_r \
    op interface \
    ports { out_r_address0 { O 15 vector } out_r_ce0 { O 1 bit } out_r_we0 { O 1 bit } out_r_d0 { O 32 vector } } \
} "
} else {
