...
set C_modelArgList {
	...
	{ p1 float 32 regular {array 7688 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "out_r", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "p1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7"],
		...
		"Port" : [
			...
			{"Name" : "p1", "Type" : "Memory", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0"},
	...
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.topp_am_addmul_5neOg_U17", "Parent" : "0"}]}
