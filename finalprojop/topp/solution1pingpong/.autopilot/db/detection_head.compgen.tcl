...
set ID 51
set hasByteEnable 0
set MemName detection_head_sum
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename f5 \
    op interface \
    ports { f5_address0 { O 11 vector } f5_ce0 { O 1 bit } f5_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'f5'"
}
}
