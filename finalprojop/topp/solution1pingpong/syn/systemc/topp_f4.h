...
protected:
    ...
    topp_f4_memcore* topp_f4_memcore_U;
...
public:
    ~topp_f4();
    SC_CTOR(topp_f4) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        topp_f4_memcore_U = new topp_f4_memcore("topp_f4_memcore_U");
        topp_f4_memcore_U->clk      ( clk );
        topp_f4_memcore_U->reset    ( reset );
        topp_f4_memcore_U->ce0      ( i_ce0 );
        topp_f4_memcore_U->we0      ( i_we0 );
        topp_f4_memcore_U->address0 ( memcore_iaddr );
        topp_f4_memcore_U->d0       ( i_d0 );
        topp_f4_memcore_U->q0       ( i_q0 );

        topp_f4_memcore_U->ce1      ( t_ce0 );
        topp_f4_memcore_U->we1      ( t_we0 );
        topp_f4_memcore_U->address1 ( memcore_taddr );
        topp_f4_memcore_U->d1       ( t_d0 );
        topp_f4_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "topp_f4.trace");
            // ports
