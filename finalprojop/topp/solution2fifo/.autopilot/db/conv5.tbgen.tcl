...
set C_modelArgList {
	...
	{ f4 float 32 regular {fifo 0 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "out_r", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "f4", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ f4_dout sc_in sc_lv 32 signal 1 } 
	{ f4_empty_n sc_in sc_logic 1 signal 1 } 
	{ f4_read sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "f4_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "f4", "role": "dout" }} , 
 	{ "name": "f4_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "f4", "role": "empty_n" }} , 
 	{ "name": "f4_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "f4", "role": "read" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"Port" : [
			...
			{"Name" : "f4", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "f4_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "linbu_0", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "linbu_1", "Type" : "Memory", "Direction" : "IO"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.linbu_0_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.linbu_1_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.win_buf_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.topp_fadd_32ns_32bkb_U38", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.topp_fmul_32ns_32cud_U39", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "25921", "Max" : "10246721"}
	, {"Name" : "Interval", "Min" : "25921", "Max" : "10246721"}
]}
...
set Spec2ImplPortList { 
	...
	f4 { ap_fifo {  { f4_dout fifo_data 0 32 }  { f4_empty_n fifo_status 0 1 }  { f4_read fifo_update 1 1 } } }
}
