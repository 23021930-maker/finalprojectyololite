...
set C_modelArgList {
	...
	{ f1 float 32 regular {fifo 0 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "out_r", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "f1", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ f1_dout sc_in sc_lv 32 signal 1 } 
	{ f1_empty_n sc_in sc_logic 1 signal 1 } 
	{ f1_read sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "f1_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "f1", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "f1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "48113", "Max" : "48113"}
	, {"Name" : "Interval", "Min" : "48113", "Max" : "48113"}
]}
...
set Spec2ImplPortList { 
	...
	f1 { ap_fifo {  { f1_dout fifo_data 0 32 }  { f1_empty_n fifo_status 0 1 }  { f1_read fifo_update 1 1 } } }
}
