...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_p1_0 \
    op interface \
    ports { p1_0_dout { I 32 vector } p1_0_empty_n { I 1 bit } p1_0_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_p1_1 \
    op interface \
    ports { p1_1_dout { I 32 vector } p1_1_empty_n { I 1 bit } p1_1_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_p1_2 \
    op interface \
    ports { p1_2_dout { I 32 vector } p1_2_empty_n { I 1 bit } p1_2_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_p1_3 \
    op interface \
    ports { p1_3_dout { I 32 vector } p1_3_empty_n { I 1 bit } p1_3_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_p1_4 \
    op interface \
    ports { p1_4_dout { I 32 vector } p1_4_empty_n { I 1 bit } p1_4_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_p1_5 \
    op interface \
    ports { p1_5_dout { I 32 vector } p1_5_empty_n { I 1 bit } p1_5_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_p1_6 \
    op interface \
    ports { p1_6_dout { I 32 vector } p1_6_empty_n { I 1 bit } p1_6_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_p1_7 \
    op interface \
    ports { p1_7_dout { I 32 vector } p1_7_empty_n { I 1 bit } p1_7_read { O 1 bit } } \
} "
}
